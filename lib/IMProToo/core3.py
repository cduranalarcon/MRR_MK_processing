...
## ADDED "," errors='ignored'" in "allData = open(file, 'r', errors='ignore')""
...
from tools3 import unix2date, date2unix, limitMaInidces, quantile
from tools3 import oneD2twoD, _get_netCDF_module
__version__ = "0.103"
